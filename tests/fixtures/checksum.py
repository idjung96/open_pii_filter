...
All algorithms implemented from scratch (no external library) so fixture
generation does not depend on any crypto/validation package. See §6.2 of the
requirements for the authoritative specifications.
"""
